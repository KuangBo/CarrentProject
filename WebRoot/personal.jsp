...
<link href="css/style_personal.css" rel="stylesheet" type="text/css" media="all" />
	...
	<div class="main-agilerow">
		<div class="sub-w3lsright agileits-w3layouts">
			...
			<form action="<%=persondoUrl %>?carid=<%=carid %>" method="post"> 
				...
				<input type="text" name="uesrid" placeholder="User Id" required="">			
...
<%									
 ...
 %>								
	...
	<div class="copyw3-agile">
		<p> © 2017 Car Rental Form. All rights reserved | Design by kuangbo minweixiao.....</a></p>
	</div>
</div>	
